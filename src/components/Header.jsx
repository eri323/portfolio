...
export default function Header() {
  ...
  return (
    <header
      id="site-header"
      className="fixed top-0 w-full z-50 border-b border-border backdrop-blur-xl"
      style={{ backgroundColor: "rgba(19, 19, 21, 0.6)" }}
    >
      <div className="max-w-[1600px] mx-auto flex justify-between items-center px-6 lg:px-16 py-3">
        {/* Left: Branding */}
